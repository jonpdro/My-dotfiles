...
local user_opts = {
    ...
    volseekbar = nil,          -- volume seekbar visibility, true/nil
    ...
    seekrangestyle = "none",-- bar, line, slider, inverted or none
    ...
    seekbarkeyframes = nil,    -- use keyframes when dragging the seekbar
    ...
    livemarkers = nil,         -- update seekbar chapter markers on duration change
    chapters_osd = nil,        -- whether to show chapters OSD on next/prev
